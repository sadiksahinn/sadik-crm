    ...
    <main className="min-h-screen bg-[#F5F6FA] text-slate-950 px-4 pt-5 pb-32">
      ...
      <header className="flex items-center gap-3 mb-6">
        ...
        <div className="flex-1">
          <p className="text-[#1E3A5F] text-xs font-black tracking-wide">MÜŞTERİ</p>
      ...
      {editing && (
        <section className="bg-white rounded-[24px] p-4 shadow-sm mb-4 grid gap-3">
          ...
          <button onClick={saveEdit} className="bg-gradient-to-r from-[#0B1437] to-[#1E3A5F] text-white rounded-2xl py-3 font-black text-sm">
            Kaydet
          </button>
        </section>
      )}
      ...
      {/* Aktif hizmet */}
      {activeService && (
        <section className="bg-gradient-to-br from-[#0B1437] to-[#1E3A5F] rounded-[24px] p-4 shadow-sm mb-4 text-white">
            ...
            {upcomingContent.map((c) => (
              <div key={c.id} className="bg-white rounded-[20px] p-3 shadow-sm flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 bg-[#1E3A5F]/10 rounded-xl flex items-center justify-center text-lg">◉</div>
                  <div>
          ...
          <div className="grid gap-2">
            {logs.map((l) => (
              <div key={l.id} className="bg-white rounded-[20px] p-3 shadow-sm flex gap-3">
                <div className="h-9 w-9 bg-[#1E3A5F]/10 rounded-xl flex items-center justify-center text-sm font-black text-[#1E3A5F] flex-shrink-0">
      ...
      <section className="bg-white rounded-[24px] p-4 shadow-sm mb-4">
        ...
        <div className="grid gap-2 text-sm">
          ...
          {customer.phone && (
            <div className="flex justify-between"><span className="text-slate-500">Telefon</span><a href={`tel:${customer.phone}`} className="font-black text-[#1E3A5F]">{customer.phone}</a></div>
          )}
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Link
          href="/asistan"
          className="flex flex-col items-center justify-center bg-gradient-to-br from-[#0B1437] to-[#1E3A5F] rounded-[24px] p-4 shadow-sm gap-1 text-white"
        >
          <span className="text-2xl">💬</span>
