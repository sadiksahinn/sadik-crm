    ...
    <main className="v-enter min-h-screen bg-[#f7f8fc] text-slate-950 px-4 pt-5 pb-32">
      ...
      <section className="bg-white rounded-[28px] p-4 shadow-sm mb-5">
        <div className="grid grid-cols-2 gap-2 mb-4">
          <button onClick={() => setTab("gelir")} className={`rounded-2xl p-4 font-black ${tab === "gelir" ? "bg-gradient-to-r from-[#3fa7c9] to-[#e0a23c] text-white" : "bg-slate-100"}`}>Gelir Ekle</button>
          <button onClick={() => setTab("gider")} className={`rounded-2xl p-4 font-black ${tab === "gider" ? "bg-gradient-to-r from-[#3fa7c9] to-[#e0a23c] text-white" : "bg-slate-100"}`}>Gider Ekle</button>
        </div>
        ...
        <form onSubmit={save} className="grid gap-3">
          ...
          <button className="bg-gradient-to-r from-[#3fa7c9] to-[#e0a23c] text-white rounded-2xl p-4 font-black">{tab === "gelir" ? "Geliri Kaydet" : "Gideri Kaydet"}</button>
        </form>
      </section>
          ...
          <div className="bg-white rounded-t-[32px] p-5 w-full shadow-2xl">
            ...
            <div className="grid gap-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button onClick={updateRecord} className="bg-gradient-to-r from-[#3fa7c9] to-[#e0a23c] text-white rounded-2xl p-4 font-black">Kaydet</button>
